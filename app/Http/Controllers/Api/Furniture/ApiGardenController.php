...
class ApiGardenController extends Controller
{
    ...
    public function storeService(Request $request)
    {
        ...
        $is_created = GardenService::create([
    ...
    public function accept_offer(Request $request){
        ...
        if($is_create){
            $service = GardenService::find($request->service_id);
    ...
    public function showService($id)
    {
        ...
        $is_created = GardenService::find($id);
