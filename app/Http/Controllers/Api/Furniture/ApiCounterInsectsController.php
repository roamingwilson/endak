...
class ApiCounterInsectsController extends Controller
{
    ...
    public function storeService(Request $request)
    {
        ...
        $is_created = CounterInsectsService::create([
    ...
    public function accept_offer(Request $request){
        ...
        if($is_create){
            $service = CounterInsectsService::find($request->service_id);
    ...
    public function service_provider_index(){
        $services = CounterInsectsService::get();
    ...
    public function showService($id)
    {
        ...
        $is_created = CounterInsectsService::find($id);
        $offers = GeneralComments::where('commentable_id',$id)->where('commentable_type' ,'App\Models\CounterInsectsService')->get();
