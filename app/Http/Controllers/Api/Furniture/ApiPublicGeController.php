...
class ApiPublicGeController extends Controller
{
    public function index()
    {
        $inputs_name = [
            ...
            'images' => "array",
            'neighborhood' => ['type' => "text" , 'name' => 'neighborhood' , 'title'  => "الحي"],
    ...
    public function storeService(Request $request)
    {
        ...
        $is_created = PublicGeService::create([
    ...
    public function accept_offer(Request $request){
        ...
        if($is_create){
            $service = PublicGeService::find($request->service_id);
    ...
    public function showService($id)
    {
        ...
        $is_created = PublicGeService::find($id);
        $offers = GeneralComments::where('commentable_id',$id)->where('commentable_type' ,'App\Models\PublicGeService')->get();
