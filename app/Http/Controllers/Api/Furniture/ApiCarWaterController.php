...
class ApiCarWaterController extends Controller
{
    public function index()
    {
        $inputs_name = [
            'user_id' => "auth user id ",
            'drink_width' => ['type' => "number" , 'drink_width' => 'neighborhood' , 'title'  => "مياة صالحة للشرب"],
            'wall_width' => ['type' => "number" , 'name' => 'wall_width' , 'title' => 'مياة صرف صحي'],
    ...
    public function storeService(Request $request)
    {
        ...
        $is_created = CarWaterService::create([
    ...
    public function accept_offer(Request $request){
        ...
        if($is_create){
            $service = CarWaterService::find($request->service_id);
    ...
    public function showService($id)
    {
        ...
        $is_created = CarWaterService::find($id);
