...
class ApiTeacherController extends Controller
{
    ...
    public function storeService(Request $request)
    {
        ...
        $is_created = TeacherService::create([
    ...
    public function accept_offer(Request $request){
        ...
        if($is_create){
            $service = TeacherService::find($request->service_id);
    ...
    public function showService($id)
    {
        ...
        $is_created = TeacherService::find($id);
        $offers = GeneralComments::where('commentable_id',$id)->where('commentable_type' ,'App\Models\TeacherService')->get();
        $data = ['service' => $is_created , 'offers' => $offers];        return response()->apiSuccess($data, 'success', 200);
