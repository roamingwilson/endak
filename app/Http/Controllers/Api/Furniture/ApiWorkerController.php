...
class ApiWorkerController extends Controller
{
    ...
    public function storeService(Request $request)
    {
        ...
        $is_created = WorkerService::create([
    ...
    public function accept_offer(Request $request){
        ...
        if($is_create){
            $service = WorkerService::find($request->service_id);
    ...
    public function service_provider_add_offer(Request $request){
        ...
        if($comment){
            $customer->notify(new CommentNotification([
                ...
                'body' => "$comment->notes",
                'url' => route('show_myservice' , $request->service_id)
            ]));
        }
    ...
    public function showService($id)
    {
        ...
        $is_created = WorkerService::find($id);
        $offers = GeneralComments::where('commentable_id',$id)->where('commentable_type' ,'App\Models\WorkerService')->get();
