...
class ApiAdsController extends Controller
{
    ...
    public function accept_offer(Request $request){
        ...
        if($is_create){
            $service = AdsService::find($request->service_id);
    ...
    public function showService($id)
    {
        ...
        $is_created = AdsService::find($id);
        $offers = GeneralComments::where('commentable_id',$id)->where('commentable_type' ,'App\Models\AdsService')->get();
