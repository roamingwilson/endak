...
class ApiCleaningController extends Controller
{
    ...
    public function storeService(Request $request)
    {
        ...
        $is_created = CleaningService::create([
    ...
    public function accept_offer(Request $request){
        ...
        if($is_create){
            $service = CleaningService::find($request->service_id);
    ...
    public function showService($id)
    {
        ...
        $is_created = CleaningService::find($id);
        $offers = GeneralComments::where('commentable_id',$id)->where('commentable_type' ,'App\Models\CleaningService')->get();
