            ...
            <div class="row justify-content-center">
                <div class="col-xl-8">
                    <div class="card">
                        ...
                        $user = auth()->user();
                        if ($user) {
                            $is_add = App\Models\GeneralComments::where('commentable_type', 'App\Models\TeacherService')->where('commentable_id', $service->id)->where('service_provider', $user->id)->first();
                        }
