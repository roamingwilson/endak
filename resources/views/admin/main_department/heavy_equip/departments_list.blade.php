...
<a href="{{route('admin.heavy_equip.add_sub_department')}}" class=" ml-1 mb-2 btn btn-primary btn-xl" data-toggle="tooltip" title="@lang('general.add')"> <i class="la la-plus"></i> </a>
                 ...
                 <div class="cls_table table-responsive">
                    <table class="table table-bordered admin-categories-list">
                        ...
                        @foreach($departments as $department)
                            @include('admin.main_department.heavy_equip.department_loop', ['department' => $department])
