                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-12 text-center">
                            <div class="">
                                <p class="mb-3 content-1 h5 fs-1">{{ ($lang == 'ar')? 'عمال وحرفيين باليومية' : "Worker By Days" }}
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="position-relative">
                                    <a href="{{ route('main_worker_show_my_service', $service->id) }}">
                                        @if ($service->image)
                                ...
                                <div class="card-body d-flex flex-column">
                                    <h5><a href="{{ route('main_worker_show_my_service', $service->id) }}">
    ...
    <section class="profile-cover-container mb-2" >
        ...
        <div class="profile-content pt-40">
            <div class="container position-relative d-flex justify-content-center ">
                <?php $user = auth()->user(); ?>
                <form action="{{ route('worker_store_service') }}" method="POST" enctype="multipart/form-data"
