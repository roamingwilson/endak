        ...
        <section class="profile-cover-container mb-2">
            ...
            <div class="profile-content pt-40">
                ...
                <div class="container position-relative d-flex justify-content-center mt-4">
                    <?php $user = auth()->user(); ?>
                    <form action="{{route('services',$service->id)}}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input class="form-control" name="images[]" type="file" multiple value="{{ old('images', $service->images) }}">
                        </div>
                        <div class="form-group mt-2">
