                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    <div class="position-relative">
                                        <a href="{{ route('main_maintenance_show_my_service', $service->id) }}">
                                            @if ($service->image)
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        <h5><a href="{{ route('main_maintenance_show_my_service', $service->id) }}">
        ...
        <section class="profile-cover-container mb-2" >
            ...
            <div class="profile-content pt-40">
                <div class="container position-relative d-flex justify-content-center ">
                    <?php $user = auth()->user(); ?>
                    <form action="{{ route('maintenance_store_service' ) }}" method="POST" enctype="multipart/form-data"
                        style="width:600px;margin-top:10px" class="profile-card rounded-lg shadow-xs bg-white p-15 p-md-30">
                        @csrf
                        <input type="hidden" name="user_id" value="{{ $user->id }}">
                        <input type="hidden" name="maintenance_id" value="{{ $main->id }}">
