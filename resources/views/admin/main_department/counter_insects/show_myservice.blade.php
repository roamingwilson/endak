            ...
            <div class="row justify-content-center">
                <div class="col-xl-8">
                    <div class="card">
                                                ...
                                                <div class="border mb-4 p-4 br-5"
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        @if (auth()->check() && auth()->id() == $service->user_id)
                                                            ...
                                                            <form action="{{ route('accept_offer_counter_insects') }}"
                                                                method="post">
                                                                @csrf
                        ...
                        $user = auth()->user();
                        if ($user) {
                            $is_add = App\Models\GeneralComments::where('commentable_type' , 'App\Models\CounterInsectsService')->where('commentable_id', $service->id)
