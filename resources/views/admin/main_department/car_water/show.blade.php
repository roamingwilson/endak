                ...
                <div class="container position-relative d-flex justify-content-center ">
                    ...
                    <form action="{{ route('services.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="form-group mt-2 d-flex align-items-center">
                            ...
                            <div>
                                <label>
                                    <input type="radio" name="drink_width" value="18"
                                        class="m-2">{{ $lang == 'ar' ? '18 طن' : '18 Tons' }}
                                </label>
                                <label>
                                    <input type="radio" name="drink_width" value="32"
                        ...
                        <div class="form-group mt-2 d-flex align-items-center">
                            ...
                            <div>
                                <label>
                                    <input type="radio" name="wall_width" value="18"
                                        class="m-2">{{ $lang == 'ar' ? '18 طن' : '18 Tons' }}
                                </label>
                                <label>
                                    <input type="radio" name="wall_width" value="32"
                                        class="m-2">{{ $lang == 'ar' ? '32 طن' : '32 Tons' }}
                                </label>
                            </div>
                        </div>
