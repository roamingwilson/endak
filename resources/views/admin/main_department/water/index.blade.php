        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">    {{ ($lang == 'ar')? 'فلاتر مياة شرب' : "Drinking water filters" }}
                    ...
                    <table id="example2" class="table table-bordered table-hover">
                        <thead>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="image" >
                                        <img width="100" height="100" src="{{ $water->image_url ?? "" }}" alt="Not" class="custom_img">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.water.edit' , $water->id) }}">
