                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    <div class="position-relative">
                                        <a href="{{ route('main_cleaning_show_my_service', $service->id) }}">
                                            @if ($service->image)
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        <h5><a href="{{ route('main_cleaning_show_my_service', $service->id) }}">
        ...
        <section class="profile-cover-container mb-2" >
            ...
            <div class="profile-content pt-40">
                <div class="container position-relative d-flex justify-content-center ">
                    <?php $user = auth()->user(); ?>
                    <form action="{{ route('cleaning_store_service') }}" method="POST" enctype="multipart/form-data"
