                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-12 text-center">
                            <div class="">
                                <p class="mb-3 content-1 h5 fs-1"> {{ $lang == 'ar' ? 'شاحنات' : 'Van Truck' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xl-12">
                        <div class="row">
                            <div class="cards-container">
                                @foreach ($van_truck as $item)
                                    <div class="card card-custom ">
                                        @if ($item->image)
                                            <a href="{{ route('van_truck_sub_show' , $item->id) }}" class="d-flex justify-content-center align-items-center">
                                                <img src="{{ $item->image_url }}" class="card-img-top mt-2 "
                                                    alt="{{ $item->name_ar }}">
                                            </a>
                                        @endif
                                        <div class="card-body">
                                            <a href="{{ route('van_truck_sub_show' , $item->id) }}">
