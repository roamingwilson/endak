<tr class="bg-category-step{{ $department->step }}">
    ...
    <td>
        <a href="{{ route('admin.van_truck.edit', $department->id) }}" class="btn btn-primary btn-sm"><i
                class="la la-pencil"></i> </a>
        <a href="{{ route('admin.van_truck.show_sub_department', $department->id) }}" class="btn btn-outline-info btn-sm"
            target="_blank"><i class="la la-eye"></i> </a>
        <a href="{{ route('admin.van_truck.delete', $department->id) }}" class="btn btn-danger btn-sm"
