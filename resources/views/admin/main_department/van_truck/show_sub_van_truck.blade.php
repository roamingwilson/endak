...
@php
    ...
    $departments = Department::where('name_en', 'Truks')->first();
                ...
                <div class="container position-relative d-flex justify-content-center ">
                    ...
                    <form action="{{ route('services.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="form-group mt-2">
                            ...
                            <label for="name" class="mb-1">{{ $lang == 'ar' ? ' الي الحي' : 'Neighborhood' }} :
                            </label>
                        ...
                        <div class="form-group mt-2">
                            <label for="name" class="mb-1">{{ $lang == 'ar' ? ' التاريخ والوقت' : 'Time' }} :
                            </label>
