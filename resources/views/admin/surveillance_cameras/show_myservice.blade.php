                        ...
                        <div class="col-md-12 text-center">
                            <div class="">
                                <p class="mb-3 content-1 h5 text-white">
                                    {{ $lang == 'ar' ? 'قسم كاميرات مراقبة ' : 'Surveillance Cameras' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div style="width:100%" class="profile-card rounded-lg shadow-xs bg-white p-15 p-md-30">
                    ...
                    <div class="form-group">
                        <label for="" class="mb-1">{{ $lang == 'ar' ? 'صاحب العمل' : 'Customer' }}
                            :</label>
                        <span class="">{{ $service->user->fullname }} </span>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-8">
                    <div class="card">
                                                ...
                                                <div class="border mb-4 p-4 br-5"
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        @if (auth()->check() && auth()->id() == $service->user_id)
                                                            ...
                                                            <form action="{{ route('accept_offer_surveillance_cameras') }}"
                                                                method="post">
                                                                @csrf
                        ...
                        $user = auth()->user();
                        if ($user) {
                            $is_add = App\Models\GeneralComments::where('commentable_id', $service->id)->where('commentable_type', 'App\Models\FollowCameraService')->where('service_provider', $user->id)->first();
                        }
