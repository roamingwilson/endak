        <!-- Start::footer -->
        <footer class="footer bg-primary mt-auto text-white position-relative" style="background-color: #007bff">
            ...
            <div class="py-5"  style="background-color: #007bff">
            ...
            <div class="py-3 border-top border-white-2 text-center"  style="background-color: #007bff">
                <div class="container">
