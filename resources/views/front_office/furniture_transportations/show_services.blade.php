                                        ...
                                        <div class="col-md-6">
                                            <div class="card">
                                                <div class="position-relative">
                                                    ...
                                                    <span
                                                        class="badge bg-secondary blog-badge">{{ $furniture_transportation_service->add_order }}</span>
                                                </div>
                                                <div class="card-body d-flex flex-column">
                                                    <h5><a
                                                            href="{{ route('main_furniture_transportations_show_my_service', $furniture_transportation_service->id) }}">
                                                            {{ $lang == 'ar' ? 'نقل عفش' : 'Furniture Transportations' }}
                                                        </a></h5>
                                                    <div class="tx-muted">
                                                        {{ $lang == 'ar' ? 'نقل عفش' : 'Furniture Transportations' }}
