                                    ...
                                    <div class="card">
                                        <div class="position-relative">
                                            <a href="{{ route('departments.show' , $department->id) }}">
                                                ...
                                                @else
                                                <img class="card-img-top" src="{{ asset('images/logo.jpg') }}" alt="nn" width="300" height="300">
                                        ...
                                        <div class="card-body d-flex flex-column">
                                            <h5><a href="{{ route('departments.show' , $department->id) }}"> {{ ($lang == 'ar') ? $department->name_ar : $department->name_en }}</a></h5>
