...
@section('content')
                                ...
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="position-relative">
                                            <a
                                                href="{{ route('main_furniture_transportations_show_my_service', $service->id) }}">
                                                @if ($service->image)
    ...
    <section class="profile-cover-container mb-2">
                    ...
                    @forelse ($inputs as $input)
                        @if ($input->name != 'notes')
                            <div class="form-group">
                                <label for="name"
                                    class="mb-1">{{ $lang == 'ar' ? $input->title_ar : $input->title_en }} :
                                </label>
        ...
        {{-- <section class="profile-cover-container mb-2">
            ...
            <div class="profile-content pt-40">
                <div class="container position-relative d-flex justify-content-center ">
                    <form action="{{ route('furniture_transportations_store_service') }}" method="POST"
                        ...
                        <div class="form-group mt-2" style="text-align: right;margin-right:10px">
                            <button class="btn mt-2 form-control"
                                style="background-color: #fdca3d">{{ __('general.save') }}</button>
                        </div>
                    </form>
