                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-xl-8 col-lg-9 col-md-8 col-sm-8 mb-2"> 
                                         @if ($user->role_id == 1)
                                            <h6 class="mb-0">
                                                    {{ $order->service_provider_garden->first_name . ' ' . $order->service_provider_garden->last_name }}
                                            </h6>
                                        @elseif ($user->role_id == 3)
                                            <h6 class="mb-0">{{ $order->customer_garden->first_name . ' ' . $order->customer_garden->last_name }}
                                            </h6>
                                        @endif
                                        <hr>
                                        ...
                                        <div class="col-12 col-xl-8 col-lg-9 col-md-8 col-sm-8 mb-2">
                                            ...
                                            <a href="{{ route('show_order_garden', $order->id) }}"
